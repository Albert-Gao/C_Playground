...
struct treenode{
    ...
    tree_colour colour; /* Red of Black*/
 ...
 * @param b second interger for comparions. 
 * 
 ...
 * sets the left trees successor as the left child of the root
 * and resets the root pointer. 
 * 
 ...
 * sets the right trees pre-successor as the right child of the root
 * and resets the root pointer. 
 * 
 * Used by tree fix function. 
 * 
...
/* DELETE ME IF IM NOT BEING USED ... THANK YOU void node_print(tree b){
    printf("%s",b->key);
    }
*/

/**
 * Travese the tree using preorder which means visit the root first.
 * 
 * @param b the tree need to travese
 * @param f the function which will be invoked while travesal
 */ 
